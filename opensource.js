...
#OpenSourceInject:hover {
  ...
  const js = `
  const texto = "Coloque seu texto aqui => "; /* Coloque o texto para modificar o comportamento do chatGPT aqui */
  ...
  function OpenClick(){
    ...
    function executeCode() {
      ...
      const EnvButton = document.querySelector('[data-testid="send-button"]');
      if(EnvButton){
      EnvButton.style="background-color: rgb(171, 104, 255);"
      }
